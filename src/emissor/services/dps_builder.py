...
def build_dps(
    ...
    _sub(cserv, "cTribNac", emitter.c_trib_nac)
    _sub(cserv, "xDescServ", emitter.x_desc_serv)
    _sub(cserv, "cNBS", emitter.c_nbs)
    com_ext = _sub(serv, "comExt")
    _sub(com_ext, "mdPrestacao", "4")
    _sub(com_ext, "vincPrest", "0")
    _sub(com_ext, "tpMoeda", emitter.tp_moeda)
    ...
    _sub(trib_mun, "cPaisResult", emitter.c_pais_result)
